...
## División de los datasets en Training y Test.

**POR AHORA SOLO SE HA DIVIDIDO EL CORAZON**
```{r}
set.seed(101)
...
```{r}
nn_corazon <- neuralnet("In_hospital_death ~ DiasABP_mean + HR_mean + MAP_mean + NIDiasABP_mean + NIMAP_mean + NISysABP_mean + PaCO2_mean + PaO2_mean + pH_mean + SysABP_mean", 
...
```{r}
metrics(nn_corazon, data_tidy_corazon.test_set, FALSE)
```
